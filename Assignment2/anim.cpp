...
void drawWater(mat4 model_trans, mat4 view_trans) {
    // draw water
    model_trans *= Scale(25,0.1,25);
    model_trans *= Translate(0, -25,0);
    model_view = view_trans * model_trans;
    set_colour(0.05f, 0.70f, 0.85f);
    drawCube();
}

void drawGoal(mat4 model_trans, mat4 view_trans) {
    // draw top crossbar
    // draw left crossbar
    // draw right crossbar
    mvstack.push(model_trans);
    model_trans *= Translate(0, 0.15*sin(3*TIME), -10);
    model_trans *= Scale(9,0.3,0.3);
    ...
    model_trans *= Translate(-1.4+0.15*sin(3*TIME), 4.5, -10);
    model_trans *= Scale(3, 0.3, 0.3);
    model_view = view_trans * model_trans;
    drawCube();
...
void drawPlayer(mat4 model_trans, mat4 view_trans) {
    mvstack.push(model_trans);
    set_colour(0.9, 0.7, 0.5);
    
    // draw body
    model_trans *= Translate(-2,-2+0.3*sin(TIME), 2);
    model_trans *= RotateY(30*sin(TIME));
    model_trans *= Scale(0.3,1,0.3);
    ...
    model_trans *= Scale(0.25, 0.1, 1.5);
    model_trans *= Translate(0,6,1.5);
...
***************************************************************/
    drawWater(model_trans, view_trans);
    
    drawGoal(model_trans, view_trans);
    
    drawPlayer(model_trans, view_trans);
...
//    model_trans *= Translate(-1.5, -1.25+0.3*sin(TIME), 2);
//    model_trans *= RotateY(-90);
//
...
//    model_trans *= Translate(-1, -0.8+0.3*sin(TIME), 2);
//    model_trans *= RotateX(90+30*sin(TIME));
//    model_trans *= Scale(0.1, 0.1, 0.5);
//    model_view = view_trans * model_trans;
//    drawCylinder();
    mvstack.pop();
